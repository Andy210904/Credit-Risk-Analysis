        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ 
            ...
            <CardContent sx={{ textAlign: 'center' }}>
              ...
              <Typography variant="h3" component="div" color="success.main" sx={{ fontWeight: 'bold', my: 1 }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ 
            ...
            <CardContent sx={{ textAlign: 'center' }}>
              ...
              <Typography variant="h3" component="div" color="warning.main" sx={{ fontWeight: 'bold', my: 1 }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ 
            ...
            <CardContent sx={{ textAlign: 'center' }}>
              ...
              <Typography variant="h3" component="div" color="error" sx={{ fontWeight: 'bold', my: 1 }}>
        ...
        <CardContent>
            ...
            <Grid item xs={12} md={4}>
              <Box sx={{ 
                ...
                <Typography variant="h6" color="warning.main" sx={{ fontWeight: 'bold' }}>
                  {loading ? '...' : `${dashboardStats.moderate_risk_percentage}%`}
                </Typography>
              </Box>
            </Grid>
          ...
          <Box sx={{ mt: 3, display: 'flex', justifyContent: 'center' }}>
            <Typography variant="body2" color="textSecondary">
              Risk Distribution: {dashboardStats.low_risk_count} Low • {dashboardStats.moderate_risk_count} Moderate • {dashboardStats.high_risk_count} High
            </Typography>
          </Box>
        </CardContent>
      </Card>
